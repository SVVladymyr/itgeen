...
$(".timeline").before("<div class='tl-nav-wrapper'><ul class='tl-nav'></ul></div><a class='tl-items-arrow-left'></a><a class='tl-items-arrow-right'></a>");
...
// The nav's arrows
$(".tl-nav-wrapper").append("<a class='tl-nav-arrow-left'></a><a class='tl-nav-arrow-right'></a>");
...
var navLimit = (navWidth - $(".tl-nav-wrapper").outerWidth(true) - 10) * -1;

// To the left
$(".tl-nav-arrow-left").on("click", function() {
  if(navTranslation < 0) {
    navTranslation = navTranslation + 285;
